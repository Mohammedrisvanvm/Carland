...
exports.mailServiceTakeOff = void 0;
const config_1 = require("./config");
const mailServiceTakeOff = (email, name, bookingDetails) => {
    const mailOptions = {
    ...
    <p>Thank you for choosing Car Land. <span style=" solid font-size:1.4em;color:#04c72e; p-2"> Your take off request approved </span></p>
    <p>Booking Details:</p>
    <ul>
...
exports.mailServiceTakeOff = mailServiceTakeOff;
//# sourceMappingURL=takeOffMail.js.map