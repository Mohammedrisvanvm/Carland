...
exports.mailServiceCancelBooking = void 0;
const config_1 = require("./config");
const mailServiceCancelBooking = (email, name, bookingDetails) => {
    const mailOptions = {
    ...
    <p>Thank you for choosing Car Land. <span style="font-size:1.4em;color:#e60505; p-2"> Your order is successfully cancelled </span></p>
    <p>Booking Details:</p>
    <ul>
...
exports.mailServiceCancelBooking = mailServiceCancelBooking;
//# sourceMappingURL=cancelBookingMail.js.map