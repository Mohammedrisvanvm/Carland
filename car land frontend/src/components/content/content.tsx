        ...
        <>
          ...
          <div className="" >
            <div className="w-full h-screen  p-5">
              <div className="bg-white relative h-full w-full p-10  flex justify-center">
                <img src="/8dd5f9b4eed2343b936a87bde8390b48.jpg"  className="object-cover w-full h-5/6" alt="" />
                <div className="absolute  bottom-20 shadow rounded-xl border-zinc-400 h-56  sm:h-56 sm:w-2/3 w-4/5 bg-white  sm:px-0 px-2 sm:grid sm:grid-cols-3">
                  {" "}
