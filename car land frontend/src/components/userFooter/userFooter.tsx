        ...
        <div className="grid row-gap-6 sm:grid-cols-2 lg:grid-cols-4 ">
          ...
          <div className="mt-10">
            ...
            <p className="mt-4 text-sm text-gray-500">
              Stay updated with our latest offers and promotions by following us
              on social media. Connect with Car Land on Twitter, Instagram,
              Facebook and for exciting deals and travel tips.
            </p>
          </div>
        </div>
