...
export const LoginHeader = () => {
    ...
    return (
        ...
        <div className="flex items-center ml-auto">
          ...
          <div
          className={`z-50 ${isToggled ? 'block' : 'hidden'
        } my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 w-21`}
    id="user-dropdown"
      >
