const CarList = () => {
  return (
    <>
      <div className="relative overflow-x-hidden shadow-md sm:rounded-lg mt-14">
        <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white flex justify-center mb-12">
          Car Details
        </span>
        ...
        <table className="w-fill text-sm text-left text-gray-500 dark:text-gray-400">
