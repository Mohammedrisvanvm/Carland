...
export const userprofileData=async(gender:string,userName:string | null | undefined):Promise<AxiosResponse>=>{
  return await axiosBase.patch("/users/stuff/userprofileData",{gender,userName})
}