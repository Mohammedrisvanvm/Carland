...
export const SignupSchema = yup.object().shape({
    ...
    password: yup.string().trim().min(6).matches(password, { message: 'please create strong password' }).required(),
...
export const LoginSchema=yup.object().shape({
    ...
    email: yup.string().email('enter a valid email').required(),
    password: yup.string().trim().min(6).matches(password, { message: 'please enter password Atleast 6 characters' }).required(),
})
